	...
	<div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
		...
		<div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-10"
			...
			<a href="/admin/index.php">
				<img alt="Logo" src="../../public/img/home/logo-no-background.png" class="h-35px" />
			</a>
		</div>
		<!--end::Logo-->
		<!--begin::Nav-->
												...
												<div data-kt-search-element="results" class="d-none">
													...
													<div class="scroll-y mh-200px mh-lg-350px">
														...
														<a href="#"
															...
															<!--begin::Symbol-->
															<div class="symbol symbol-40px me-4">
																<img src="../dist/assets/media/avatars/150-8.jpg"
																	alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
														...
														<a href="#"
															...
															<!--begin::Symbol-->
															<div class="symbol symbol-40px me-4">
																<img src="../dist/assets/media/avatars/150-11.jpg"
																	alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
														...
														<a href="#"
															...
															<!--begin::Symbol-->
															<div class="symbol symbol-40px me-4">
																<img src="../dist/assets/media/avatars/150-12.jpg"
																	alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
										...
										<div class="menu-sub menu-sub-accordion">
											<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
												...
												<div class="menu-item">
													<a class="menu-link" href="index.php?url=rating">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Danh sách đánh giá</span>
													</a>
												</div>
											</div>
