					...
					<table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
						...
						<tbody class="fw-bold text-gray-600">
							...
							foreach ($listsanpham as $sanpham) {
								extract($sanpham);
								$editproducts = "index.php?url=editproducts&product_id=" . $product_id;
								$deleteproducts = "index.php?url=deleteproducts&product_id=" . $product_id;
								$hinhpath = "../public/uploads/images/" . $img;

								// Format giá
								$giaFormatted = number_format($price, 0, ',', '.');
								$giaWithCurrency = $giaFormatted . ' VNĐ';
								...
								echo '                        
                                            <tr>
                                                ...
                                                <td>' . $product_name . '</td>
                                                <td>' . $img . '</td>
                                                <td>' . $giaWithCurrency . '</td>
                                            
                                                <td>' . $category_name . '</td>
                                             
                                                <td>
                                                    <a href="' . $editproducts . '"><input class="btn btn-warning" type="button"  value="Sửa"></a> 
                                                    <a href="#" onclick="confirmDelete(\'' . $deleteproducts . '\')"><input type="button" class="btn btn-danger" value="Xóa"></a>
                                                </td>
                                            </tr>';
