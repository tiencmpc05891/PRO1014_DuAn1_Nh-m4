                        ...
                        <form class="form" action="#">
                            ...
                            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" name="user_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Tên sản phẩm" />
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" name="price" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Giá tiền" />

                                </div>

                                <div class="d-flex flex-column mb-7 fv-row" data-select2-id="select2-data-83-awib">

                                    <label class="required fs-6 fw-bold form-label mb-2">Danh mục</label>

                                    <select class="form-select form-select-solid fw-bolder select2-hidden-accessible" name="status" data-control="select2" data-placeholder="Mời chọn danh mục" data-hide-search="true" data-select2-id="select2-data-10-o2c3" tabindex="-1" aria-hidden="true">
                                        <option data-select2-id="select2-data-12-st15"></option>
                                        <option value="0" data-select2-id="select2-data-90-6cvl">Danh mục 1</option>
                                        <option value="1" data-select2-id="select2-data-91-kr3m">Danh mục 2</option>
                                        <option value="2" data-select2-id="select2-data-92-5w5d">Danh mục 3</option>
                                        <option value="3" data-select2-id="select2-data-93-cy06">Danh mục 4</option>
                                        <option value="4" data-select2-id="select2-data-94-r4e9">Danh mục 5</option>
                                    </select>
                                    <!--end::Input-->
                                ...
                                <!-- <div class="d-flex flex-column mb-7 fv-row">
                                    ...
                                    <select name="cate" aria-label="Danh mục" data-control="cate" class="form-select form-select-solid fw-bolder">
                            ...
                            <div class="text-center pt-15">
                                <button type="reset" class="btn btn-light me-3" data-kt-users-modal-action="cancel">Hủy</button>
