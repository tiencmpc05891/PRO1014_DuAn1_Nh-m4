        ...
        <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0"
                ...
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-dark">Cập nhật quản trị viên</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            <!--end::Page title=-->
            ...
            <div class="card card-flush">
                ...
                <div class="card-header mt-6">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="index.php?url=admin"><input type="button" value="Danh sách quản trị viên"
                ...
                <div class="card-body pt-0">
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form class="form" action="index.php?url=updateadmin" method="POST">
                            <input type="hidden" name="password" value="<?php if (isset($password) && ($password != ""))
                                echo $password; ?>">
                            <input type="hidden" name="admin_id" value="<?php if (isset($admin_id) && ($admin_id != ""))
                                echo $admin_id; ?>">
                            <div class="fv-row mb-7">
                                <label class="fs-6 fw-bold form-label mb-2">
                                    <span class="required">Tên</span>
                                </label>
                                <input type="text" name="username" value="<?php if (isset($username) && ($username != ""))
                                    echo $username; ?>" class="form-control form-control-solid">
                            </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select name="role" class="form-control form-control-solid">
                                    <option value="1" <?php if (isset($role) && $role == 1)
                                        echo "selected"; ?>>Nhân viên
                                    </option>
                                    <option value="2" <?php if (isset($role) && $role == 2)
