	...
	<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
		...
		<div class="d-flex d-lg-none align-items-center ms-n2 me-2">
			...
			<a href="index.php?url=home" class="d-flex align-items-center">
				...
				<img alt="Logo" src="../../public/img/home/logo-no-background.png" class="h-30px" />
								...
								<tbody>
										...
										<td>
											<div class="d-flex align-items-center">
												<div class="symbol symbol-45px me-5">
													<img src="../../admin/dist/assets/media/avatars/150-11.jpg"
														alt="" />
												</div>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<div class="symbol symbol-45px me-5">
													<img src="../../admin/dist/assets/media/avatars/150-3.jpg" alt="" />
												</div>
												<div class="d-flex justify-content-start flex-column">
													<a href="#"
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<div class="symbol symbol-45px me-5">
													<img src="../../admin/dist/assets/media/avatars/150-4.jpg" alt="" />
												</div>
												<div class="d-flex justify-content-start flex-column">
													<a href="#"
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<div class="symbol symbol-45px me-5">
													<img src="../../admin/dist/assets/media/avatars/150-5.jpg" alt="" />
												</div>
												<div class="d-flex justify-content-start flex-column">
													<a href="#"
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<div class="symbol symbol-45px me-5">
													<img src="../../admin/dist/assets/media/avatars/150-6.jpg" alt="" />
												</div>
												<div class="d-flex justify-content-start flex-column">
													<a href="#"
					...
					<div class="card-body pt-5">
						...
						<div class="d-flex mb-7">
							...
							<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
								<img src="../../admin/dist/assets/media/stock/600x400/img-3.jpg" class="mw-100"
									alt="" />
							</div>
							<!--end::Symbol-->
							<!--begin::Section-->
						...
						<div class="d-flex mb-7">
							<!--begin::Symbol-->
							<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
								<img src="../../admin/dist/assets/media/stock/600x400/img-4.jpg" class="mw-100"
									alt="" />
							</div>
							<!--end::Symbol-->
							<!--begin::Section-->
						...
						<div class="d-flex mb-7">
							<!--begin::Symbol-->
							<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
								<img src="../../admin/dist/assets/media/stock/600x400/img-5.jpg" class="mw-100"
									alt="" />
							</div>
							<!--end::Symbol-->
							<!--begin::Section-->
						...
						<div class="d-flex mb-7">
							<!--begin::Symbol-->
							<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
								<img src="../../admin/dist/assets/media/stock/600x400/img-6.jpg" class="mw-100"
									alt="" />
							</div>
							<!--end::Symbol-->
							<!--begin::Section-->
						...
						<div class="d-flex">
							<!--begin::Symbol-->
							<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
								<img src="../../admin/dist/assets/media/stock/600x400/img-7.jpg" class="mw-100"
									alt="" />
							</div>
							<!--end::Symbol-->
							<!--begin::Section-->
				...
				<div class="card card-xxl-stretch mb-5 mb-xl-8">
					...
					<div class="card-body pt-5">
						...
						<div class="d-flex align-items-sm-center mb-7">
							...
							<div class="symbol symbol-50px me-5">
								<span class="symbol-label">
									<img src="../../admin/dist/assets/media/svg/brand-logos/plurk.svg"
						...
						<div class="d-flex align-items-sm-center">
							...
							<div class="symbol symbol-50px me-5">
								<span class="symbol-label">
									<img src="../../admin/dist/assets/media/svg/brand-logos/fox-hub.svg"
										class="h-50 align-self-center" alt="" />
								</span>
							</div>
							<!--end::Symbol-->
				...
				<div class="card card-xl-stretch mb-xl-8">
					...
					<div class="card-body pt-2">
						...
						<div class="d-flex align-items-center mb-7">
							<!--begin::Avatar-->
							<div class="symbol symbol-50px me-5">
								<img src="../../admin/dist/assets/media/avatars/150-1.jpg" class="" alt="" />
							</div>
							<!--end::Avatar-->
							<!--begin::Text-->
							<div class="flex-grow-1">
						...
						<div class="d-flex align-items-center mb-7">
							<!--begin::Avatar-->
							<div class="symbol symbol-50px me-5">
								<img src="../../admin/dist/assets/media/avatars/150-4.jpg" class="" alt="" />
							</div>
							<!--end::Avatar-->
							<!--begin::Text-->
							<div class="flex-grow-1">
						...
						<div class="d-flex align-items-center mb-7">
							<!--begin::Avatar-->
							<div class="symbol symbol-50px me-5">
								<img src="../../admin/dist/assets/media/avatars/150-12.jpg" class="" alt="" />
							</div>
							<!--end::Avatar-->
							<!--begin::Text-->
							<div class="flex-grow-1">
						...
						<div class="d-flex align-items-center mb-7">
							<!--begin::Avatar-->
							<div class="symbol symbol-50px me-5">
								<img src="../../admin/dist/assets/media/avatars/150-8.jpg" class="" alt="" />
							</div>
							<!--end::Avatar-->
							<!--begin::Text-->
							<div class="flex-grow-1">
						...
						<div class="d-flex align-items-center">
							<!--begin::Avatar-->
							<div class="symbol symbol-50px me-5">
								<img src="../../admin/dist/assets/media/avatars/150-6.jpg" class="" alt="" />
							</div>
							<!--end::Avatar-->
							<!--begin::Text-->
							<div class="flex-grow-1">
						...
						<div class="mt-5">
							...
							<div class="d-flex flex-stack mb-5">
								...
								<div class="d-flex align-items-center me-2">
									...
									<div class="symbol symbol-50px me-3">
										<div class="symbol-label bg-light">
											<img src="../../admin/dist/assets/media/svg/brand-logos/figma-1.svg"
												class="h-50" alt="" />
										</div>
									</div>
									<!--end::Symbol-->
