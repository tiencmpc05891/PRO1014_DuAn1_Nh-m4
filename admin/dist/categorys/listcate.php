					...
					<table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
						...
						<tbody class="fw-bold text-gray-600">
							...
							foreach ($listdanhmuc as $danhmuc) {
								extract($danhmuc);
								$editcate = "index.php?url=editcate&category_id=" . $category_id;
								$deletecate = "index.php?url=deletecate&category_id=" . $category_id;
                                ...
                                <tr>
									...
									<td>' . $created_at . '</td>
                                    <td>
                                        <a href="' . $editcate . '"><input class="btn btn-warning" type="button" value="Sửa"></a> 
                                        <a href="" onclick="confirmDelete(\'' . $deletecate . '\')"><input class="btn btn-danger" type="button" value="Xóa"></a>
                                    </td>
