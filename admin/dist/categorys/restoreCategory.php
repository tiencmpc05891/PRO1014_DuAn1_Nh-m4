<?php
$listdanhmuc = $danhmuc->show_deleted_categories();
?>
            ...
            <div class="card card-flush">
                ...
                <div class="card-header mt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="index.php?url=listcate"><input type="button" value="Danh sách danh mục"
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Ngày xóa</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <?php foreach ($listdanhmuc as $danhmuc): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.php?url=restoreCategory&category_id=<?= $danhmuc['category_id'] ?>"
                                            onclick="return confirm('Bạn có chắc chắn muốn khôi phục danh mục này?')">
                                            <input class="btn btn-primary" type="button" value="Khôi phục">
                                        </a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
...
<script>
    function confirmDelete(url) {
        var r = confirm("Bạn có chắc chắn muốn khôi phục?");
        if (r == true) {
