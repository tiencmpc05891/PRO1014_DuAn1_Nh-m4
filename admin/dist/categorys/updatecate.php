            ...
            <div class="card card-flush">
                ...
                <div class="card-body pt-0">
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form class="form" action="index.php?url=updatecate" method="POST">
                            <div class="fv-row mb-7">

        
                                <input type="hidden" name="category_id" value="<?php if (isset ($category_id) && ($category_id != ""))
                                    echo $category_id; ?> ">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="category_name" value="<?php if (isset ($category_name) && ($category_name != ""))
                                    echo $category_name; ?>" class="form-control form-control-solid">
