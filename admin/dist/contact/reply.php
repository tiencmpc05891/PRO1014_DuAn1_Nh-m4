    ...
    <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
        ...
        <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0"
                ...
                <!--begin::Heading-->
                <h1 class="text-dark fw-bolder my-0 fs-2">Quản lý liên hệ</h1>
                <!--end::Heading-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">Quản lý liên hệ</li>
                    <li class="breadcrumb-item text-dark">Phản hồi liên hệ</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            <!--end::Page title=-->
            ...
            <div class="card card-flush">
                ...
                <div class="card-header mt-6">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="index.php?url=contact"><input type="button" value="Danh sách liên hệ"
                ...
                <div class="card-body pt-0">
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form class="form" action="index.php?url=replyContact" method="POST">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <label class="fs-6 fw-bold form-label mb-2">
                                    <span class="required">Email khách hàng</span>
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover"
                                        data-bs-trigger="hover" data-bs-html="true"
                                        data-bs-content="Danh mục chỉ có một."></i>
                                </label>

                                <input type="text" name="email" value="<?php if (isset($email) && ($email != ""))
                                    echo $email; ?>" class="form-control form-control-solid">
                            </div>
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="title" value="" class="form-control form-control-solid">
                            </div>
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="content" value="" class="form-control form-control-solid">
                            </div>

                            <div class="text-center pt-15">
                                <button type="reset" class="btn btn-light me-3"
                                    data-kt-permissions-modal-action="cancel">Hủy</button>
                                <input type="submit" name="update" value="Gửi" class="btn btn-primary">
                            </div>
                            <!--end::Actions-->
                        </form>
                        <!--end::Form-->
