                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                ...
                                <!--end::Svg Icon-->Thêm bài viết</button>
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header" id="kt_modal_add_user_header">
                                        <!--begin::Modal title-->
                                        <h2 class="fw-bolder">Thêm mới bài viết</h2>
                                        <!--end::Modal title-->
                                        <!--begin::Close-->
                                        <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                            data-kt-users-modal-action="close">
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        ...
                                        <form id="kt_modal_add_user_form" class="form" action="#">
                                            ...
                                            <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                ...
                                                <div class="fv-row mb-7">
                                                    <!--begin::Label-->
                                                    <label class="d-block fw-bold fs-6 mb-5">Ảnh bài viết</label>
                                                    <!--end::Label-->
                                                    <!--begin::Image input-->
                                                ...
                                                <div class="fv-row mb-7">
                                                    <!--begin::Label-->
                                                    <label class="required fw-bold fs-6 mb-2">Tiêu đề</label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                ...
                                                <div class="fv-row mb-7">
                                                    <label class="fs-6 fw-bold form-label mb-2">Nội dung</label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <textarea
                                                ...
                                                <div class="fv-row mb-7">
                                                    <!--begin::Label-->
                                                    <label class="required fw-bold fs-6 mb-2">Người tạo</label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                ...
                                                <div class="fv-row mb-7">
													<!--begin::Label-->
													<label class="fs-6 fw-bold form-label mb-2">
														<span class="required">Ngày đăng bài</span>
													...
													<!--end::Label-->
													<!--begin::Input-->
													<input class="form-control form-control-solid" type="date"  name="task_duedate" id="kt_modal_add_task_datepicker" />
													<!--end::Input-->
												</div>
                                            </div>
                                            <!--end::Scroll-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px">Mã bài viết</th>
                                <th class="min-w-100px">Tiêu đề</th>
                                <th class="min-w-100px">Nội dung</th>
                                <th class="min-w-100px">Người viết bài</th>
                                <th class="min-w-100px">Ngày đăng bài</th>
